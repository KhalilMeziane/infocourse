            ...
            <Header>
                <div className="container mx-auto flex items-center h-full text-gray-900">
                    <div className="md:w-10/12 xl:w-8/12 mx-auto">
                        <h1 className="text-3xl lg:text-4xl capitalize font-bold leading-snug text-center">Master 1 <span className="uppercase">isil</span>+<span className="uppercase">isia</span></h1>
                    </div>
                </div>
            </Header>
            <main>
